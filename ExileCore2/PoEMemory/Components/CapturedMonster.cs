...
namespace ExileCore2.PoEMemory.Components
{
	...
	public class CapturedMonster : Component
	{
		...
		// (get) Token: 0x06001632 RID: 5682 RVA: 0x001B366C File Offset: 0x001B366C
		public MonsterVariety MonsterVariety
		{
			get
			{
				/*
An exception occurred when decompiling this method (06001632)
...
*/;
		...
		// Token: 0x06001633 RID: 5683 RVA: 0x001B36B8 File Offset: 0x001B36B8
