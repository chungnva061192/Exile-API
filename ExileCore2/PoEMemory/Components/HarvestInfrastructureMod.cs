...
namespace ExileCore2.PoEMemory.Components
{
	...
	{
		// Token: 0x0600166E RID: 5742 RVA: 0x001B3F58 File Offset: 0x001B3F58
		internal HarvestInfrastructureMod(HarvestInfrastructureModUnmanaged data, IMemory m)
		{
			/*
An exception occurred when decompiling this method (0600166E)

ICSharpCode.Decompiler.DecompilerException: Error decompiling System.Void ExileCore2.PoEMemory.Components.HarvestInfrastructureMod::.ctor(ExileCore2.PoEMemory.Components.HarvestInfrastructureModUnmanaged,ExileCore2.Shared.Interfaces.IMemory)
...
*/;
		...
		// (get) Token: 0x0600166F RID: 5743 RVA: 0x001B3FB0 File Offset: 0x001B3FB0
		public int ModLevel
		{
			[CompilerGenerated]
			get
		...
		// (get) Token: 0x06001670 RID: 5744 RVA: 0x001B3FB8 File Offset: 0x001B3FB8
		...
		// Token: 0x06001671 RID: 5745 RVA: 0x001B3FC0 File Offset: 0x001B3FC0
		public override string ToString()
		{
			/*
An exception occurred when decompiling this method (06001671)

ICSharpCode.Decompiler.DecompilerException: Error decompiling System.String ExileCore2.PoEMemory.Components.HarvestInfrastructureMod::ToString()
