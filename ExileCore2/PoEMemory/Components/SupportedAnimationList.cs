...
namespace ExileCore2.PoEMemory.Components
{
	...
	public class SupportedAnimationList : StructuredRemoteMemoryObject<ActorAnimationListOffsets>
	{
		...
		// (get) Token: 0x060015CF RID: 5583 RVA: 0x001B2A30 File Offset: 0x001B2A30
		public List<AnimationStageList> Animations
		{
			get
			{
				/*
An exception occurred when decompiling this method (060015CF)
...
*/;
		...
		// Token: 0x060015D0 RID: 5584 RVA: 0x001B2A80 File Offset: 0x001B2A80
