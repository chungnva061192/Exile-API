...
namespace ExileCore2.PoEMemory.FilesInMemory
{
	...
	{
		// Token: 0x060010DB RID: 4315 RVA: 0x001A535C File Offset: 0x001A535C
		...
		// Token: 0x060010DC RID: 4316 RVA: 0x001A5368 File Offset: 0x001A5368
		protected new void EntryAdded(long addr, BestiaryCapturableMonster entry)
		{
			/*
An exception occurred when decompiling this method (060010DC)

ICSharpCode.Decompiler.DecompilerException: Error decompiling System.Void ExileCore2.PoEMemory.FilesInMemory.BestiaryCapturableMonsters::EntryAdded(System.Int64,ExileCore2.PoEMemory.MemoryObjects.Bestiary.BestiaryCapturableMonster)
