...
namespace ExileCore2.PoEMemory.FilesInMemory
{
	...
	{
		// Token: 0x06001130 RID: 4400 RVA: 0x001A65EC File Offset: 0x001A65EC
		...
		// Token: 0x06001131 RID: 4401 RVA: 0x001A6604 File Offset: 0x001A6604
...
ICSharpCode.Decompiler.DecompilerException: Error decompiling System.Void ExileCore2.PoEMemory.FilesInMemory.ItemVisualIdentities::EntryAdded(System.Int64,ExileCore2.PoEMemory.FilesInMemory.ItemVisualIdentity)
...
*/;
		...
		// Token: 0x06001132 RID: 4402 RVA: 0x001A6650 File Offset: 0x001A6650
		public List<ItemVisualIdentity> GetByArtPath(string artPath)
		{
			/*
An exception occurred when decompiling this method (06001132)

ICSharpCode.Decompiler.DecompilerException: Error decompiling System.Collections.Generic.List`1<ExileCore2.PoEMemory.FilesInMemory.ItemVisualIdentity> ExileCore2.PoEMemory.FilesInMemory.ItemVisualIdentities::GetByArtPath(System.String)
