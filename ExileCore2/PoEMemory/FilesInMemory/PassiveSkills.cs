...
namespace ExileCore2.PoEMemory.FilesInMemory
{
	...
	{
		// Token: 0x060011C5 RID: 4549 RVA: 0x001A859C File Offset: 0x001A859C
		...
		// (get) Token: 0x060011C6 RID: 4550 RVA: 0x001A85B4 File Offset: 0x001A85B4
		public Dictionary<int, PassiveSkill> PassiveSkillsDictionary
		{
			[CompilerGenerated]
			get
			{
		...
		// (get) Token: 0x060011C7 RID: 4551 RVA: 0x001A85BC File Offset: 0x001A85BC
		public new IList<PassiveSkill> EntriesList
		{
			get
			{
				/*
An exception occurred when decompiling this method (060011C7)

ICSharpCode.Decompiler.DecompilerException: Error decompiling System.Collections.Generic.IList`1<ExileCore2.PoEMemory.FilesInMemory.PassiveSkill> ExileCore2.PoEMemory.FilesInMemory.PassiveSkills::get_EntriesList()
...
*/;
		...
		// Token: 0x060011C8 RID: 4552 RVA: 0x001A85E8 File Offset: 0x001A85E8
		public PassiveSkill GetPassiveSkillByPassiveId(int index)
		{
			/*
An exception occurred when decompiling this method (060011C8)

ICSharpCode.Decompiler.DecompilerException: Error decompiling ExileCore2.PoEMemory.FilesInMemory.PassiveSkill ExileCore2.PoEMemory.FilesInMemory.PassiveSkills::GetPassiveSkillByPassiveId(System.Int32)
...
*/;
		...
		// Token: 0x060011C9 RID: 4553 RVA: 0x001A8674 File Offset: 0x001A8674
		public PassiveSkill GetPassiveSkillById(string id)
		{
			/*
An exception occurred when decompiling this method (060011C9)

ICSharpCode.Decompiler.DecompilerException: Error decompiling ExileCore2.PoEMemory.FilesInMemory.PassiveSkill ExileCore2.PoEMemory.FilesInMemory.PassiveSkills::GetPassiveSkillById(System.String)
...
*/;
		...
		// Token: 0x060011CA RID: 4554 RVA: 0x001A86AC File Offset: 0x001A86AC
		...
		// Token: 0x060011CB RID: 4555 RVA: 0x001A86C4 File Offset: 0x001A86C4
		public new PassiveSkill GetByAddress(long address)
		{
			/*
An exception occurred when decompiling this method (060011CB)

ICSharpCode.Decompiler.DecompilerException: Error decompiling ExileCore2.PoEMemory.FilesInMemory.PassiveSkill ExileCore2.PoEMemory.FilesInMemory.PassiveSkills::GetByAddress(System.Int64)
