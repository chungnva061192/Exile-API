...
namespace ExileCore2.PoEMemory.FilesInMemory
{
	...
	{
		// Token: 0x060011CE RID: 4558 RVA: 0x001A8700 File Offset: 0x001A8700
		...
		// (get) Token: 0x060011CF RID: 4559 RVA: 0x001A8718 File Offset: 0x001A8718
		public new IList<ProphecyDat> EntriesList
		{
			get
			{
				return this;
		...
		// Token: 0x060011D0 RID: 4560 RVA: 0x001A8728 File Offset: 0x001A8728
		public ProphecyDat GetProphecyById(int index)
		{
			/*
An exception occurred when decompiling this method (060011D0)

ICSharpCode.Decompiler.DecompilerException: Error decompiling ExileCore2.PoEMemory.MemoryObjects.Archive.ProphecyDat ExileCore2.PoEMemory.FilesInMemory.PropheciesDat::GetProphecyById(System.Int32)
...
*/;
		...
		// Token: 0x060011D1 RID: 4561 RVA: 0x001A87B4 File Offset: 0x001A87B4
		protected new void EntryAdded(long addr, ProphecyDat entry)
		{
			/*
An exception occurred when decompiling this method (060011D1)

ICSharpCode.Decompiler.DecompilerException: Error decompiling System.Void ExileCore2.PoEMemory.FilesInMemory.PropheciesDat::EntryAdded(System.Int64,ExileCore2.PoEMemory.MemoryObjects.Archive.ProphecyDat)
...
*/;
		...
		// Token: 0x060011D2 RID: 4562 RVA: 0x001A87F0 File Offset: 0x001A87F0
		public new ProphecyDat GetByAddress(long address)
		{
			/*
An exception occurred when decompiling this method (060011D2)

ICSharpCode.Decompiler.DecompilerException: Error decompiling ExileCore2.PoEMemory.MemoryObjects.Archive.ProphecyDat ExileCore2.PoEMemory.FilesInMemory.PropheciesDat::GetByAddress(System.Int64)
...
*/;
		...
		private readonly Dictionary<int, ProphecyDat> ProphecyIndexDictionary;
	}
}
