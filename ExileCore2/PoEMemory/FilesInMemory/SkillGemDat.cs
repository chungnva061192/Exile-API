...
namespace ExileCore2.PoEMemory.FilesInMemory
{
	...
	public class SkillGemDat : RemoteMemoryObject
	{
		...
		// (get) Token: 0x060011EE RID: 4590 RVA: 0x001A8CC4 File Offset: 0x001A8CC4
		public BaseItemType ItemType
		{
			get
			{
				/*
An exception occurred when decompiling this method (060011EE)

ICSharpCode.Decompiler.DecompilerException: Error decompiling ExileCore2.PoEMemory.Models.BaseItemType ExileCore2.PoEMemory.FilesInMemory.SkillGemDat::get_ItemType()
...
*/;
		...
		// (get) Token: 0x060011EF RID: 4591 RVA: 0x001A8D0C File Offset: 0x001A8D0C
...
ICSharpCode.Decompiler.DecompilerException: Error decompiling System.Collections.Generic.List`1<ExileCore2.PoEMemory.FilesInMemory.GemEffect> ExileCore2.PoEMemory.FilesInMemory.SkillGemDat::get_GemEffects()
...
*/;
		...
		// Token: 0x060011F0 RID: 4592 RVA: 0x001A8D78 File Offset: 0x001A8D78
		public override string ToString()
		{
			/*
An exception occurred when decompiling this method (060011F0)

ICSharpCode.Decompiler.DecompilerException: Error decompiling System.String ExileCore2.PoEMemory.FilesInMemory.SkillGemDat::ToString()
...
*/;
		...
		// Token: 0x060011F1 RID: 4593 RVA: 0x001A8DD8 File Offset: 0x001A8DD8
		public SkillGemDat()
		{
			this;
		}
		...
		private BaseItemType _itemType;

		// Token: 0x0400812C RID: 33068
		private List<GemEffect> _gemEffects;
	}
}
