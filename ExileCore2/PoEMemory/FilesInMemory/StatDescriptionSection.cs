...
namespace ExileCore2.PoEMemory.FilesInMemory
{
	...
	public class StatDescriptionSection : StructuredRemoteMemoryObject<StatDescriptionStringContainer>
	{
		...
		// (get) Token: 0x0600121F RID: 4639 RVA: 0x001A9464 File Offset: 0x001A9464
		...
		public List<ValueTuple<int, int>> StatRanges
		{
			...
			{
				/*
An exception occurred when decompiling this method (0600121F)

ICSharpCode.Decompiler.DecompilerException: Error decompiling System.Collections.Generic.List`1<System.ValueTuple`2<System.Int32,System.Int32>> ExileCore2.PoEMemory.FilesInMemory.StatDescriptionSection::get_StatRanges()
...
*/;
		...
		// (get) Token: 0x06001220 RID: 4640 RVA: 0x001A94C8 File Offset: 0x001A94C8
		public List<StatHandling> StatConversionTypes
		{
			get
			{
				/*
An exception occurred when decompiling this method (06001220)

ICSharpCode.Decompiler.DecompilerException: Error decompiling System.Collections.Generic.List`1<ExileCore2.PoEMemory.FilesInMemory.StatHandling> ExileCore2.PoEMemory.FilesInMemory.StatDescriptionSection::get_StatConversionTypes()
...
*/;
		...
		// (get) Token: 0x06001221 RID: 4641 RVA: 0x001A9504 File Offset: 0x001A9504
		public string String
		{
			get
			{
				/*
An exception occurred when decompiling this method (06001221)

ICSharpCode.Decompiler.DecompilerException: Error decompiling System.String ExileCore2.PoEMemory.FilesInMemory.StatDescriptionSection::get_String()
...
*/;
		...
		// Token: 0x06001222 RID: 4642 RVA: 0x001A9540 File Offset: 0x001A9540
		public StatDescriptionSection()
		{
			this;
		}

		// Token: 0x04008138 RID: 33080
		private List<ValueTuple<int, int>> _statRanges;
