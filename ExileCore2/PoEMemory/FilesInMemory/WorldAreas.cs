...
namespace ExileCore2.PoEMemory.FilesInMemory
{
	...
	{
		// Token: 0x060012BC RID: 4796 RVA: 0x001AB7CC File Offset: 0x001AB7CC
		...
		// (get) Token: 0x060012BD RID: 4797 RVA: 0x001AB7F0 File Offset: 0x001AB7F0
		public Dictionary<int, WorldArea> AreasIndexDictionary
		{
			[CompilerGenerated]
			get
			{
		...
		// (get) Token: 0x060012BE RID: 4798 RVA: 0x001AB7F8 File Offset: 0x001AB7F8
		public Dictionary<int, WorldArea> AreasWorldIdDictionary
		{
			[CompilerGenerated]
			get
			{
		...
		// Token: 0x060012BF RID: 4799 RVA: 0x001AB800 File Offset: 0x001AB800
		public WorldArea GetAreaByAreaId(int index)
		{
			/*
An exception occurred when decompiling this method (060012BF)

ICSharpCode.Decompiler.DecompilerException: Error decompiling ExileCore2.PoEMemory.MemoryObjects.WorldArea ExileCore2.PoEMemory.FilesInMemory.WorldAreas::GetAreaByAreaId(System.Int32)
...
*/;
		...
		// Token: 0x060012C0 RID: 4800 RVA: 0x001AB82C File Offset: 0x001AB82C
		public WorldArea GetAreaByAreaId(string id)
		{
			/*
An exception occurred when decompiling this method (060012C0)

ICSharpCode.Decompiler.DecompilerException: Error decompiling ExileCore2.PoEMemory.MemoryObjects.WorldArea ExileCore2.PoEMemory.FilesInMemory.WorldAreas::GetAreaByAreaId(System.String)
...
*/;
		...
		// Token: 0x060012C1 RID: 4801 RVA: 0x001AB874 File Offset: 0x001AB874
		public WorldArea GetAreaByWorldId(int id)
		{
			/*
An exception occurred when decompiling this method (060012C1)

ICSharpCode.Decompiler.DecompilerException: Error decompiling ExileCore2.PoEMemory.MemoryObjects.WorldArea ExileCore2.PoEMemory.FilesInMemory.WorldAreas::GetAreaByWorldId(System.Int32)
...
*/;
		...
		// Token: 0x060012C2 RID: 4802 RVA: 0x001AB8A0 File Offset: 0x001AB8A0
		protected override void EntryAdded(long addr, WorldArea entry)
		{
			/*
An exception occurred when decompiling this method (060012C2)

ICSharpCode.Decompiler.DecompilerException: Error decompiling System.Void ExileCore2.PoEMemory.FilesInMemory.WorldAreas::EntryAdded(System.Int64,ExileCore2.PoEMemory.MemoryObjects.WorldArea)
