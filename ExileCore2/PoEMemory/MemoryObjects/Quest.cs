...
namespace ExileCore2.PoEMemory.MemoryObjects
{
	...
	public class Quest : RemoteMemoryObject
	{
		...
		// (get) Token: 0x06000F4E RID: 3918 RVA: 0x001A13E0 File Offset: 0x001A13E0
		public string Id
		{
			get
			{
...
ICSharpCode.Decompiler.DecompilerException: Error decompiling System.String ExileCore2.PoEMemory.MemoryObjects.Quest::get_Id()
...
*/;
		...
		// (get) Token: 0x06000F4F RID: 3919 RVA: 0x001A1424 File Offset: 0x001A1424
		public int Act
		{
			get
			{
		...
		// (get) Token: 0x06000F50 RID: 3920 RVA: 0x001A143C File Offset: 0x001A143C
		public string Name
		{
			get
			{
				/*
An exception occurred when decompiling this method (06000F50)

ICSharpCode.Decompiler.DecompilerException: Error decompiling System.String ExileCore2.PoEMemory.MemoryObjects.Quest::get_Name()
...
*/;
		...
		// (get) Token: 0x06000F51 RID: 3921 RVA: 0x001A1484 File Offset: 0x001A1484
		public string Icon
		{
			get
			{
				/*
An exception occurred when decompiling this method (06000F51)

ICSharpCode.Decompiler.DecompilerException: Error decompiling System.String ExileCore2.PoEMemory.MemoryObjects.Quest::get_Icon()
...
*/;
		...
		// Token: 0x06000F52 RID: 3922 RVA: 0x001A14CC File Offset: 0x001A14CC
		public override string ToString()
		{
			/*
An exception occurred when decompiling this method (06000F52)

ICSharpCode.Decompiler.DecompilerException: Error decompiling System.String ExileCore2.PoEMemory.MemoryObjects.Quest::ToString()
...
*/;
		...
		// Token: 0x06000F53 RID: 3923 RVA: 0x001A14FC File Offset: 0x001A14FC
		public Quest()
		{
			this;
		}
